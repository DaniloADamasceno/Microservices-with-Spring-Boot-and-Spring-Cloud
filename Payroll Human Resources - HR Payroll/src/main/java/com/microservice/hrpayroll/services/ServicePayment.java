...
public class ServicePayment {
    ...
    @Value("${workersHumanResources.url.host}") // Para pegar o valor da variável de ambiente
...
public Payment getPayment(long workerId, int days) {
    ...
    Worker worker = restTemplate.getForObject(workersHumanResourcesUrlHost + "/trabalhadores/{id}", Worker.class, uriVariables);
